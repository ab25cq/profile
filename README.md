...
今はcomelangというモダンなコンパイラを作っています。comelangではvinというviクローン、zed,zed2というテキスト処理言語、shshという1000シェル、mfというコンソールファイラ、yappyというPythonクローン（途中まで）、gogoというLLCM-Cコンパイラ（途中まで）を作りました。
