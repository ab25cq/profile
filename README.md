...
タバコを吸っています。Sevenstarsが好きです。普段はvapeを吸っています。
...
その後neo-cというモダンなCコンパイラを作っています。neo-cではvinというviクローン、zedというテキスト処理言語、shshという1000シェル、mfというコンソールファイラを作りました。今も改良をしていますが、フリーソフトウェア作成はもう十分やりきった思うので、ご隠居生活です。
