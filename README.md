...
13歳くらいからコンピュータをしていてPanasonic MSX turbo R, NEC PC-9821DA MS-DOS, 自作PC Windows、MacBook、Thinkpadと使ってきました。子供のころからゲームが作りたくてプログラミングをずっとやってました。大学でUNIXを学んでからずっとUNIXプログラミングをしています。mfiler2というコンソールファイラは2chで話題になったりしました。UNIXのコンソールのユーザーインターフェースに興味があります。もともとコンソールで動くファイラを作っていましたが、シェルが好きになりシェルを作るようになりました。xyzshというRubyっぽいコマンドが動く独特のシェルです。そのシェル中に演算子が入れたくなり、それなら普通のコンピュータ言語のREPLの方が良いなと思いClover2というコンピュータ言語を作ってました。Clover2のREPLはシェル並みに強力に作ってあります。補完など。人によってはシェルの代わりに使えるかもしれません。

その後neo-cというC言語互換のC言語拡張言語を作ってました。neo-cでwiというviクローンも実装しました。

次にneo-cの改良版であるcomelangというC言語拡張言語とvinというviクローンを作ってました。完全なセルフホストも行えて、この作品でもうフリーソフトウェア作成は満足したかもしれません。また性懲りも無く何か作り出すかもしれませんが、とりあえず、一区切りです。ファボよろしくです。

また新規プロジェクト始めました。comelangでyappyというPythonクローン作ってます。
